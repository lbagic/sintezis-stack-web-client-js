...
declare global {
  interface Array<T> {
    ...
    remove<U extends T>(ids: U[Identifier<U>][], identifier?: Identifier<U>): U[];
    remove<U extends T>(item: Partial<U>): U[];
    remove<U extends T>(items: Partial<U>[]): U[];
    findOne<U extends T>(id: U[Identifier<U>], identifier?: Identifier<U>): U | undefined;
    findOne<U extends T>(item: Partial<U>): U | undefined;
    findMany<U extends T>(id: U[Identifier<U>], identifier?: Identifier<U>): U[];
    findMany<U extends T>(ids: U[Identifier<U>][], identifier?: Identifier<U>): U[];
